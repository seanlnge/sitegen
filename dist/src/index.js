...
exports.ReviseBuild = exports.Build = void 0;
...
function Build(igHandle, photoCount, chosenTemplate) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, __1.log)("Finding preferred design");
        ...
        const imgdesc = yield messageChain.describeImages(images, "Describe this image in a paragraph, including the color scheme, the main item present in this image, the overall feeling that this image presents, as well as where on a website that this image might make sense.");
        ...
        const website = yield messageChain.queryModel("gpt-4o", true);
...
exports.Build = Build;
function ReviseBuild(messageChain, template, revisionMessage, firstRevise) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (sitePicBuffer instanceof Error) {
            (0, __1.log)("Revision failed");
            return;
        }
        // After first revise, message chain is still valid
        const reviseChain = firstRevise ? new messagechain_1.MessageChain({ logPath: 'reviselog.txt', saveLog: true }) : messageChain;
        if (firstRevise) {
